...
| ------------------------------------ | -------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [react-native-phone-recipes][rec_m]    | [Download Signed Universal Android APK][rec_a]                          | Android, React Native, OAuth2, React-Hooks, Redux |
...
[rec_a]: https://github.com/steenhansen/react-native-phone-recipes/raw/main/phone-recipes-v2.apk
