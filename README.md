...
| |Repo|Site|Shared Tech|Different Tech| CI/CD  &amp; Tests|
|-|----|----|----|-----|---|
...
| **Elixir** -  Phoenix, LiveView, SVG<br> [GIT : elixir-liveview-snake][esg_g]  <br><br>[LIVE SITE : multi-player multi-game online snake game ][esg_g]|  [<img src="https://evening-eyrie-25210-f2edb2eac607.herokuapp.com/images/list-elixir.webp" height="100">](https://evening-eyrie-25210-f2edb2eac607.herokuapp.com/images/list-elixir.webp) | 
...
|   [gmap-dragdrop-examples][map_e]                                | [gmap-dragdrop-examples<br>.onrender.com][map_w] <br> <sup>[150sec free hosting cold start]</sup>             | React                       | Example of Drag&amp;Drop<br> between &amp; on Google Maps |
